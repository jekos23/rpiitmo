...
def set_motors(left_fwd, left_rev, right_fwd, right_rev):
    # The competition robot drive polarity is inverted at the motor driver level.
    # Swap forward/backward requests on both sides here so higher-level motion
    # commands keep their normal meaning.
